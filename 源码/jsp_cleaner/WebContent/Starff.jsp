	 	 ...
	 	 <table class="table" >
			<tr>
			 ...
			 %>			 
				...
				<td></td>	  	
			  	<td><%=admin.getRealName() %></td>
			  	<td></td>
			  	<td><%=admin.getState() %></td>
			  	<td></td>

			  	<td>
					<a href="UpdateAdmin?AdminID=<%=admin.getAdminID()%>">修改</a>
					<a href="DeleteAdmin?AdminID=<%=admin.getAdminID()%>">删除</a>
				 </td>
			</tr>	
			 <%
					 }
