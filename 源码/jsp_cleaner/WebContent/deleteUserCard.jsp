...
<body>
	 ...
	 <div class="handle">
	 	<form action="DeleteMember" onsubmit="return cancel()">
	 		<div>
	 			用户账号:<input type="text" name="UserID" id="UserID">
	 		</div>
	 		<div>
	 			用户余额:<input type="text" name="Balance" disabled="disabled" value="<%=session.getAttribute("Balance") %>">
			</div>
	 		<div>
	 			<input type="submit" value="注销会员" >
